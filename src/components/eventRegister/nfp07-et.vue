<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='part1Container'>
            ...
            <p>Through Our Expert Analysis Of The Influential U.S. Non-farm Payroll Data</p>
            <thirdLoginButton />
        </div>
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 50px 0; justify-content: center;'>
                ...
                >
                    <p class='text yellow'>
                        Economic Calendar<br />U.S. Non-farm Payroll : July 7, 2023
                    </p>
                    <h1 class='heading'>
...
<script>
import partner from './components/nfp07EtContent.vue'
