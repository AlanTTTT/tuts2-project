            ...
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <span class='text'>
                        ...
                        <span class='text'>
                            Friday, June 2nd 2023, The United State
                        </span>
                    </span>
                    <h1 class='heading'>
                    ...
                    <el-row class='arrowContainer' :gutter='10'>
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/g7-summit/arrowCircle.png' />
                                <p class='text'>
                                    No KYC
                                </p>
                            </div>
...
<script>
import information from './components/nfpEHcontent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/nfp/ehBanner.png");
