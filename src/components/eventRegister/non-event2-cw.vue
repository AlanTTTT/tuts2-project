    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1'>
            <video id='myVideo' autoplay loop muted>
                <source src='https://www.headline.net/wp-content/uploads/2023/07/backgroundVideoCwPage.mp4' type='video/mp4' />
            </video>
            <el-row :gutter='10' style='justify-content: center; padding-bottom: 20px;'>
                <el-col
                    :lg='14'
                    :md='14'
                    :sm='20'
                ...
                >
                    <div class='textContainer'>
                        <p class='text1'>
                            Stop Missing Winning Trades!<br />No Account? Register Now!
                        </p>
                    </div>
                    <thirdLogin2 />
                </el-col>
...
<script>
import information from './components/CwComponent7.vue'
...
import thirdLogin2 from '@/themeCommon/components/thirdLoginEvent4.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/nfp07/backgroundEvent1Cw.jpg");
