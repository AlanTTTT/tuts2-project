                ...
                >
                    <div class='regContainer'>
                        <div class='titleContainer'>
                            <img alt='jingle bell' class='bell' src='../../images/cpi1/cpi-fomc/jingleBell.png' />
                        ...
                        <h1 class='heading'>
                            One-click Trading Mode with HEADLINE
                        </h1>
                    </div>
                </el-col>
...
<script>
import information from './components/cardContainerCpiMw.vue'
