                            ...
                            <div class='registerCard'>
                                <div class='pageTitle'>
                                    <div>
                                        ...
                                        <p class='content2'>
                                            Start Trading With Us Now!<br />Just one simple click below:
                                        </p>
                                        <h1 class='heading1'>
                                            ONE - CLICK Google and Telegram  Registration
                                        </h1>
                                    </div>
...
<script>
import information from './components/CwComponent9.vue'
...
.container3{
  ...
  .row1{
    ...
    background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("../.././images/cpi1/fomc07/background3Cw.jpg");
    background-repeat: no-repeat;
    background-position: center center;
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/remarketing/backgroundSc.jpg");
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        .row1{
