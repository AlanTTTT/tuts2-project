<template>
    <div id='eventReg' ref='content' class='register'>
        <topNav />
        <div class='container'>
            <el-row class='row1' :gutter='10' style='padding: 20px 0px;'>
                <el-col
                    class='col1Container'
                    :lg='15'
                    :md='24'
                ...
                >
                    <div class='regContainer'>
                        <div class='titleContainer'>
                            <img alt='search' class='search' src='../../images/cpi1/non-event2/searchIcon.png' />
                            <h1 class='infoContainer'>
                                Our Analysis<br />
                                Your Trade
                            </h1>
                        </div>
                        <h1 class='heading'>
                            Get Real-Time Insights<br />
...
<script>
import information from './components/cardContainerJNonEventEt.vue'
import information2 from './components/nonEventEtContent2.vue'
