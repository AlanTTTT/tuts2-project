        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <span class='text'>
                        Event
                        <el-divider class='text' direction='vertical' />
                        <span class='text'>
                            Friday, August 4 2023, The United State
                        </span>
                    </span>
                    <p class='subTitle'>
                        <img alt='flag' class='flag' src='../../images/cpi1/nfp07/flagEh.jpg' />
                        NFP Strategy
                    </p>
                    <el-divider class='line1' />
                    <el-divider class='line2' />
                    <h1 class='heading'>
                        Watch Your Trades Soar with
                    </h1>
                    <h1 class='heading2'>
                        <span class='redBack'>
                    ...
                    <el-row :gutter='10' style='padding-top: 50px'>
                        ...
                        >
                            ...
                            <div class='buttonContainer'>
                                <el-button class='productButton lp_btn lp_btn_trade' plain text @click='jumpPage(1)'>
                    ...
                    <el-row class='arrowContainer' :gutter='10'>
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/eucpi/arrow.png' />
                                <p class='text'>
                                    No KYC
                                </p>
                            </div>
...
<script>
import information from './components/nfp08EhContent.vue'
...
import thirdLogin2 from '@/themeCommon/components/thirdLoginEvent5.vue'
...
.row1{
    ...
    background-color: rgba(62,12,12,0.2);
    padding: 150px 0;
  .trade{
    margin-top: 20px;
  }
...
.col1Container{
  .fire{
    filter: invert(33%) sepia(17%) saturate(5946%) hue-rotate(334deg) brightness(103%) contrast(101%);
    width: 50px;
  }
}
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/nfp07/backgroundImgEh1.png");
