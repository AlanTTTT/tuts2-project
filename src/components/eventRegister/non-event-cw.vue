        ...
        <div class='container1'>
            <el-row :gutter='10' style='justify-content: center'>
                ...
                >
                    ...
                    <p class='content'>
                        The built-in one-click trading function simplifies the trading process and significantly reduces the amount of time it takes to fulfill trades. You can use it to open and close orders, set stop-loss and take-profit levels, and place pending orders all with the minimum number of clicks.
                    </p>
...
<script>
import information from './components/CwComponent4.vue'
...
.container1 {
        background-image: url("../.././images/cpi1/non-event/7fbackground1CW.jpg");
