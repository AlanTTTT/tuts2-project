            ...
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <div class='background1'>
                        <span class='heading yellow'>
                            The Moment is Now!
                        </span>
                        <h1 class='heading'>
                            Unleash the Power of <span class='redBg'>
                                Web3 Assets
                            </span> in Your Portfolio
                        </h1>
                        <el-row class='row2' :gutter='10' style='justify-content: space-around;'>
                            <el-col
                                :lg='10'
                                :md='10'
                                :sm='20'
...
<script>
import cardContainer from './components/nonEventEhContainer.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/non-event/backgroundImgEh.jpg");
