            ...
            <el-row class='row1' :gutter='10' style='height: 100vh; justify-content: center;'>
                ...
                >
                    <span class='yellow text'>
                        ...
                        <span class='yellow text'>
                            May 19th -21st 2023 in Hiroshima, Japan
                        </span>
                    </span>
                    <h1 class='heading'>
                        G7 SUMMIT
                    ...
                    <p class='content1'>
                        In <el-link class='underline content1' href='https://www.headline.net/en-US/home' target='_blank' :underline='false'>
                            ...
                            KYC is not required
                        </span>. Start your trading to obtain maximum profits directly!
                    </p>
                </el-col>
                <el-col
                    class='col2Container'
...
<script>
import partner from './components/csContent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/g7-summit/country.jpg");
