    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1'>
            ...
            <el-row :gutter='10' style='justify-content: center'>
                ...
                >
                    <h1 class='title'>
                        European<br />Consumer Price Index
                    </h1>
                    <p class='content'>
        ...
        <div class='background3'>
            <el-row class='background3Row' :gutter='10' style='justify-content: center'>
                <el-col
                    class='background3Col'
                    :lg='14'
                    :md='16'
                    :sm='18'
                ...
                >
                    <p class='title'>
                        What is the Consumer Price Index (United Kingdom)?
                    </p>
                    <p class='content'>
                    ...
                    <p class='text'>
                        To receive Headline event notices, news, and analysis in your inbox, <el-link class='joinUs lp_btn lp_btn_InfoDetail' href='https://www.headline.net/en-US/infoDetail2?id=25762'>
                            Join us!
                        </el-link>
                    </p>
                </el-col>
...
.background3{
  background-image: url("../.././images/cpi1/eucpi/backgroundImgCw.jpg");
...
.container1 {
        background-image: url("../.././images/cpi1/eucpi/backgroundImg2Cw.jpg");
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        .background1{
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/non-event/background2CW.jpg");
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        .row1{
