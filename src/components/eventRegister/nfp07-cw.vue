<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='background1'>
            <p class='background1heading'>
                Never Again Kick Yourself for a Missed Trade
            </p>
            <p class='background1content'>
                Headline.net provides you to trade at ANYTIME and ANYWHERE
            </p>
            <div>
        ...
        <div class='container1'>
            <el-row :gutter='10' style='justify-content: center; background-color: rgba(255,255,255,0.4)'>
                <el-col
                    :lg='14'
                    :md='16'
                    :sm='18'
                    style='align-self: center; padding: 30px 0;'
                    :xl='12'
                    :xs='20'
                >
                    <h1 class='title'>
                        Non-<span>F</span>arm <span>P</span>ayroll
                    </h1>
                    <p class='subTitle'>
                        Unlocking the secrets of profitable trading
                    </p>
                    <p class='content'>
                        What is the non-farm payrolls report?<br />
                        The non-farms payroll report (NFP) is the monthly release of data on the 80% of the US workforce employed in manufacturing, construction and goods.<br />
                        As the name suggests, it does not include those who work on farms, and also excludes private households, non-profit workers and government employees. <br />
                    </p>
                    <third-login v-if='openAccountType === 0' />
                    <p class='noticeContent'>
                        To receive Headline event notices, news, and analysis in your inbox, <el-link class='registerLink lp_btn lp_btn_infoDetail' href='https://www.headline.net/en-US/infoDetail?id=27967' target='_blank'>
                            Join us!
                        </el-link>
                    </p>
                </el-col>
                            ...
                            <div class='registerCard'>
                                <div class='pageTitle'>
                                    <div>
                                        ...
                                        <p class='pageTitleContent'>
                                            Sign up for a Headline.net account to get a secure crypto experience
                                        </p>
                                    </div>
...
<script>
import information from './components/CwComponent6.vue'
...
.container1 {
        background-image: url("../.././images/cpi1/nfp07/background1Cw.jpg");
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/nfp07/background2Cw.jpg");
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        .row1{
