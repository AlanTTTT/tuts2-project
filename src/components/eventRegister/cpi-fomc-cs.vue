                ...
                >
                        ...
                        >
                            <div class='arrowContainer'>
                                ...
                                <p class='pointContainer'>
                                    Innovative<br />Trading Strategy
                                </p>
                            </div>
                        </el-col>
                        <el-col
                    ...
                    <p class='content1'>
                        In <el-link class='underline content1' href='https://www.headline.net/en-US/home' target='_blank' :underline='false'>
                            ...
                            deposit and withdraw all forms of currencies
...
<script>
import partner from './components/cpiFomcCsContent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/cpi-fomc/background_CS.jpg");
