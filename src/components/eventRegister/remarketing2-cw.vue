        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    Trading Opportunities <br /> Grab & Go
                        ...
                        >
                            ...
                            <div class='row4'>
                                <div class='textContainer'>
                                    <p class='subTitle'>
                                        Open a Demo or Live Account for FREE
                                    </p>
                                    <third-login v-if='openAccountType === 0' />
                                </div>
                                <el-divider class='line1' direction='vertical' />
                                <el-divider class='line2' direction='vertical' />
                                <div class='rowDiv'>
                                    <p class='buttonTitle'>
...
<script>
import information from './components/CwComponent12.vue'
import information2 from './components/CwComponent13.vue'
