        ...
        <div class='container'>
            <div class='container1'>
                <el-row class='row1' :gutter='10'>
                    ...
                    >
                        <h1 class='heading'>
                            Eurozone CPI Release<br />June 30, 2023
                        </h1>
                        <p class='col1ContainerContent'>
                            Headline.net helps traders make informed trading decisions and seize all the important trading opportunities.
                        </p>
                    </el-col>
                </el-row>
...
<script>
import partner from './components/eucpiCsContent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/eucpi/backgroundCs.jpg");
