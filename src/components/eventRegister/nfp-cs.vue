<template>
    <div id='eventReg' ref='content' class='register'>
        <topNav />
        <div class='container'>
            <el-row class='row1' :gutter='30' style='justify-content: center;'>
                <el-col
                    class='col1Container'
                    :lg='12'
                    :md='22'
                ...
                >
                    <span class='yellow text'>
                        Economic Calendar
                        <el-divider class='yellow' direction='vertical' />
                        <span class='yellow text'>
                            Jun 07, 2023
                        </span>
                    </span>
                    ...
                    <p class='content1'>
                        In <el-link class='underline content1' href='https://www.headline.net/en-US/home' target='_blank' :underline='false'>
                            Headline.net
                        </el-link>, you can <span class='redBack'>
                            deposit and withdraw any forms of currencies
                        </span> and <span class='redBack'>
                            KYC is not required for trading
                        </span>. <br />Start your trading to obtain maximum profits directly!
                    </p>
                </el-col>
                <el-col
                    class='col2Container'
...
<script>
import partner from './components/nfpCScontent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/nfp/nfpCSbackground.jpg");
