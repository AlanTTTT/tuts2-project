<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='part1Container'>
            ...
            <p>Through Our Expert Analysis Of The Influential U.S. Nonfarm Payrolls</p>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 50px 0; justify-content: center;'>
                ...
                >
                    <p class='text yellow'>
                        Economic Calendar<br />U.S. NFP : Aug 4, 2023
                    </p>
                    <h1 class='heading'>
                    ...
                    <p class='content1'>
                        ...
                        </span>lower than the 209,000 from the previous month, while the unemployment rate will remain at 3.6%.<br />
                        <span class='underline' style='color: #000; background-color: #FFF86B'>
                            Register now
                        </span> and check out our analysis of the NFP data.
                    </p>
...
<script>
import partner from './components/nfp08EtContent.vue'
