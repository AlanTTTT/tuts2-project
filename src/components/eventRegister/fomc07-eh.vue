        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <h1 class='heading'>
                        Capitalize on FOMC and Win Big!
                    </h1>
...
<script>
import information from './components/fomc07Ehcontent.vue'
import information2 from './components/fomc07EhContent2.vue'
...
.register {
    ...
    .container {
        background-image: url("../../images/cpi1/fomc07/bannerEh.jpg");
