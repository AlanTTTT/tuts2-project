    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container'>
            ...
            <div class='titleContainer'>
                <h1 class='title1'>
                    Our trader has over 20 years of experience with AI algorithms
                </h1>
            </div>
...
<script>
import nonEventCards from './components/fomc07ScCards.vue'
import partner from './components/fomc07Sc-content.vue'
...
.container1Background{
    background: url("../../images/cpi1/fomc07/background1Sc.jpg");
...
.register {
    ...
    .container2{
      position: relative;
      z-index: 999;
      background-color: rgba(203,13,17,0.5)
    }
    .container {
        background: url("../../images/cpi1/fomc07/background3Sc.jpg");
        background-size: cover;
        background-repeat: no-repeat;
