    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <p class='subTitle'>
                        We are an event-focus online broker
                    </p>
                    <h1 class='title'>
                        How will U.S. Non-farm Payroll Affect My money?
                    </h1>
                    <p class='text'>
                        <span style='background-color: #bad55a;'>
                            Trading Tips for your shortcut to realize a<br />Successful Investment during NFP Period
                        </span>
                    </p>
...
<script>
import information from '../promotion/nfp07-mw.vue'
...
.col1Container{
  background-image: url("../../images/cpi1/nfp07/backgroundImg1Mw.jpg");
