        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <h1 class='heading2'>
                        Double Opportunity, Unlimited Profits!
                    </h1>
                    ...
                    <el-row class='arrowContainer' :gutter='10'>
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/cpi-fomc/arrow.png' />
                                <p class='text'>
                                    No KYC
                                </p>
                            </div>
...
<script>
import information from './components/cardContainerCpiEh.vue'
...
import thirdLogin from '@/themeCommon/components/thirdLoginEvent5.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/cpi-fomc/bannerEh.png");
