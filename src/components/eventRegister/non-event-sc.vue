<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1Background'>
            <div style='background-color: rgba(255,255,255,0.4); padding: 50px 20px'>
                <h1 class='title'>
            ...
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <div class='background1'>
                        <h1 class='heading'>
                            Seize the present opportunity! Harness the potential of <span class='green'>
                                Web3 assets
                            </span> in your investment portfolio
                        </h1>
                        <el-row class='row2' :gutter='10' style='justify-content: space-between; align-items: center;'>
                            <el-col
                                :lg='12'
                                :md='12'
                                :sm='15'
                            ...
                            >
                                ...
                                <div class='buttonContainer'>
                                    <el-button class='productButton lp_btn lp_btn_register' plain text @click='jumpPage(1)'>
                                        <p class='productButton lp_btn lp_btn_register'>
                                            EUR/USD
                                        </p>
                                    </el-button>
                                    <el-button class='productButton lp_btn lp_btn_register' plain text @click='jumpPage(1)'>
                            ...
                            >
                                ...
                                <div>
                                    <img alt='fire' class='fire' src='../../images/cpi1/g7-summit/fire.png' />
                                    <img alt='fire' class='fire' src='../../images/cpi1/g7-summit/fire.png' />
                                    <img alt='fire' class='fire' src='../../images/cpi1/g7-summit/fire.png' />
                                </div>
                            </el-col>
...
<script>
import cardContainer from './components/nonEventScContainer.vue'
...
.container1Background{
    background-image: url("../.././images/cpi1/uscpi07/backgroundImgSc.jpg");
