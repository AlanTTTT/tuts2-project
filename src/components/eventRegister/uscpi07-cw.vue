    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1'>
            <div class='background1'>
                ...
                <div>
                    <el-button class='registerButton lp_btn lp_btn_infoDetail' plain text @click='jumpPage(5)'>
            ...
            <div class='background2'>
                <el-row :gutter='10' style='justify-content: center; background-color: rgba(255,255,255,0.5)'>
                    <el-col
                        :lg='17'
                        :md='18'
                        :sm='19'
                    ...
                    >
                        <h1 class='title'>
                            <span>US</span> <span>C</span>onsumer <span>P</span>rice <span>I</span>ndex
                        </h1>
                        <p class='content1'>
                        ...
                        <p class='text'>
                            To receive Headline event notices, news, and analysis in your inbox, <el-link class='joinUs lp_btn lp_btn_register' href='https://www.headline.net/en-US/register'>
                                Join us!
                            </el-link>
                        </p>
                    </el-col>
...
<script>
import information from './components/CwComponent5.vue'
...
.container1 {
        .background2{
          background-image: url("../.././images/cpi1/uscpi07/imageCw.jpg");
