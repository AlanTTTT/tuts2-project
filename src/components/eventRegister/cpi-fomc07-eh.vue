    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <h1 class='heading'>
                        USD Trading Strategies:
                    </h1>
                    <h1 class='heading2'>
                        How to Turn <span class='redBack'>
                            US CPI
                        </span> into <span class='redBack'>
                            Profits?
                        </span>
                    </h1>
                    <el-row class='row2' :gutter='10'>
                        ...
                        >
                            ...
                            <div class='buttonContainer'>
                                <el-button class='productButton lp_btn lp_btn_register' plain text @click='jumpPage(1)'>
                                    <p class='lp_btn lp_btn_register'>
                                        EUR/USD
                                    </p>
                                </el-button>
                                <el-button class='productButton lp_btn lp_btn_register' plain text @click='jumpPage(2)'>
                                    <p class='lp_btn lp_btn_register'>
                                        GOLD
                                    </p>
                                </el-button>
                                <el-button class='productButton lp_btn lp_btn_register' plain text @click='jumpPage(3)'>
                                    <p class='lp_btn lp_btn_register'>
                                        BTC/USDT
                                    </p>
                                </el-button>
                        ...
                        >
                            ...
                            <div class='fireContainer'>
                                <img alt='fire' class='fire' src='../../images/cpi1/nfp/fire.png' />
                                <img alt='fire' class='fire' src='../../images/cpi1/nfp/fire.png' />
                                <img alt='fire' class='fire' src='../../images/cpi1/nfp/fire.png' />
                            </div>
                        </el-col>
                    ...
                    <el-row class='arrowContainer' :gutter='10'>
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/eucpi/arrow2.png' />
                                <p class='text'>
                                    No KYC
                                </p>
                            </div>
...
<script>
import information from './components/eucpiEhContent.vue'
...
import thirdLogin from '@/themeCommon/components/thirdLoginEvent1.vue'
...
export default {
    ...
    setup () {
        ...
        const jumpPage = (attr) => {
            switch (attr) {
                case 1 :
                    window.open('https://www.headline.net/en-US/order?symbolId=1437&tradeType=1&name=EUR/USD')
                    break
                case 2 :
...
.col1Container{
  background-color: rgba(42, 54, 121, 0.5);
  padding: 100px 70px !important;
  .fireContainer{
    padding-top: 10px;
    .fire{
      filter: invert(36%) sepia(17%) saturate(5946%) hue-rotate(334deg) brightness(103%) contrast(101%);
      width: 50px;
    }
  }
  .row2{
...
.register {
    ...
    .container {
        background-image: url("../../images/cpi1/uscpi07/bannerEh.jpg");
