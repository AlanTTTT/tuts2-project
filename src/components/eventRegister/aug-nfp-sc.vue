<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1Background'>
            <div style='background-color: rgba(0,0,0,0.7); padding: 60px 20px'>
                <h1 class='title'>
                    Discover Unique Market Insights and Boost Your Trading Performance Now!
                </h1>
                <p class='content'>
                    Take the Leap: Click Here to Join Risk-Free and Unleash Your Trading Potential
                </p>
                <thirdLogin2 v-if='openAccountType === 0' />
            </div>
        </div>
        <div class='container'>
            <el-row class='row1' :gutter='50' style='justify-content: center; background: rgba(128, 128, 128, 0.4);'>
                <el-col
                    class='col1Container'
                    :lg='12'
                    :md='22'
                ...
                >
                    ...
                    <h1 class='heading'>
                        To capitalize on the<span class='green'>
                            NFP Data Report
                        </span> data and make a successful trade.
                    </h1>
                    <p class='content1'>
                        Experience the full potential of <span class='green'>
                            tax-free CFD trading with cryptocurrencies
                        </span> on Headline.net, a comprehensive platform that offers a wide variety of tradable assets. Enjoy a seamless registration process<span class='green'>
                            without the need for Know Your Customer (KYC) requirements.
                        </span> Capitalize on profitable opportunities in the market and embark on your CFD trading adventure. Sign up today and tap into the benefits of trading tax-free with crypto on Headline.net.
                    </p>
                </el-col>
                <el-col
                    class='col2Container'
                ...
                >
                    <div class='container2'>
                        ...
                        >
                            ...
                            <div class='to-login'>
                                <h1>Don't Miss Out - Tap Below to Sign Up Now!</h1>
                                <p>Sign up for free account today!</p>
                            </div>
                            <thirdLogin v-if='openAccountType === 0' />
                            <div class='part2Button'>
                                <el-button class='home lp_btn lp_btn_deposit' plain @click='handleSkip()'>
                                    <span class='lp_btn lp_btn_deposit'>
                                        TRADE NOW
                                    </span>
                                </el-button>
                            </div>
...
<script>
import partner from './components/aug-nfp-ScContent.vue'
...
.container1Background{
    background-image: url("../.././images/cpi1/uscpi07/backgroundImgSc.png");
...
.register {
    ...
    .part2Button{
      ...
      margin: 20px;
      .home{
        background-color: #1aff35 !important;
        color: #000;
        border-radius: 25px;
        width: 250px;
        height: 45px;
