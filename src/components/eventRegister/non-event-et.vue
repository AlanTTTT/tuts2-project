    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 50px 0; justify-content: center;'>
                ...
                >
                    <p class='text yellow'>
                        Headline.net <el-divider class='yellow vertical' direction='vertical' /> Your Ultimate CFDs Trading Platform
                    </p>
                    <h1 class='heading'>
                        Trade CFDs with Ease and
                    </h1>
                    ...
                    <p class='content1'>
                        ...
                        <span class='red'>
                            Register now and start trading CFDs with Headline.net
                        </span>
                    </p>
                </el-col>
                <el-col
...
<script>
import partner from './components/nonEventEtContent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/non-event/backgroundET.jpg");
