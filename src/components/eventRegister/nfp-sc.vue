<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <section class='bannerContainer'>
            <el-row class='row1' :gutter='10' style='justify-content: center;'>
                <el-col
                    class='col1Container'
                    :lg='14'
                    :md='20'
                ...
                >
                    ...
                    <el-row class='row2'>
                        <el-col
                            ...
                            :xs='20'
                        >
                            <img alt='money' class='point' src='../../images/cpi1/g7-summit/money.png' />
                        ...
                        <el-col
                            ...
                            :xs='0'
                        >
                            <el-divider class='dividerContainer' direction='vertical' style='height: 100%;' />
                        </el-col>
                        <el-col
                            class='colPart2'
                            :lg='4'
                            ...
                            :xs='20'
                        >
                            <img alt='dollars' class='point' src='../../images/cpi1/g7-summit/dollars.png' />
                            <div style='align-self: center;'>
                                <p class='advans'>
                                    Tax free
                                </p>
                        ...
                        <el-col
                            ...
                            :xs='20'
                        >
                            <img alt='people' class='point' src='../../images/cpi1/g7-summit/people.png' />
                            <div style='align-self: center;'>
                                <p class='advans'>
                                    No Needed
                                </p>
...
<script>
import summit from './components/nfpSCsummit.vue'
import forecasting from './components/nfpForecasting.vue'
import partner from './components/summit-scPartner.vue'
...
.bannerContainer{
  background: linear-gradient(rgba(0,0,0,.4), rgba(0,0,0,.4)), url("../../images/cpi1/nfp/bannerSC.png");
