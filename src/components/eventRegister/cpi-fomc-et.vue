<template>
    <div id='eventReg' ref='content' class='register'>
        <topNav />
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 100px 0; justify-content: center;'>
                <el-col
                    class='col1Container'
                    :lg='12'
                    :md='22'
                ...
                >
                    ...
                    <h1 class='heading'>
                        Guess The Next Move Of The Market
                    </h1>
                    <h1 class='yellow heading'>
                        And WIN Big!
                    </h1>
                    <p class='content1'>
                        Headline.net is a CFD trading platform that offers a wide range of features and benefits, including <span class='red'>
                            the ability to use Crypto to trade CFDs
                        </span>, <span class='red'>
                            NO KYC requirements
                        </span>, <span class='red'>
                            tax-free profits
...
<script>
import partner from './components/cpiFomcEtContent.vue'
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/cpi-fomc/background1Sc.jpg");
