<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='part1Container'>
            ...
            <p>Through Our Expert Analysis Of The Influential U.S. CPI</p>
            <thirdLoginButton v-if='openAccountType === 0' />
        </div>
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 50px 0; justify-content: center;'>
                <el-col
                    class='col1Container'
                    :lg='12'
                    :md='22'
                ...
                >
                    <p class='text yellow'>
                        Economic Calendar<br />U.S. CPI : Aug 10, 2023
                    </p>
                    <h1 class='heading'>
                        Check out our analysis to
                    </h1>
                    <h1 class='yellow heading'>
                        Boost Your Trading Portfolio!
                    </h1>
                    <p class='content1'>
                        <span class='red underline'>
                            The market expects the CPI to rise by 2.8% in July 2023,
                        </span>compared to a year ago. The forecast is based on expectations that energy prices will continue to decline, while food prices will remain elevated.<br />
                        <span class='underline' style='color: #000; background-color: #FFF86B'>
                            Register now
                        </span> and check out our analysis of the CPI data.
                    </p>
                    <el-row class='row2' :gutter='20'>
                        <el-col
                            class='row2col1Container'
                            :lg='4'
                            :md='5'
                            :sm='22'
                            style='align-self: center;'
...
<script>
import partner from './components/cpi08EtContent.vue'
...
import thirdLogin from '@/themeCommon/components/thirdLoginEvent7.vue'
...
.part1Container{
  background-color: rgb(197 190 193);
  text-align: center;
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/eucpi/backgroundImgEt.jpg");
        ...
        .vertical{
          border-left: 2px solid #fdc254 !important;
        }
        .text{
          font-size: 30px;
          font-weight: bold;
