    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <section class='videoContainer'>
            <video id='myVideo' autoplay loop muted>
                <source src='https://www.headline.net/wp-content/uploads/2023/05/G7video.mp4' type='video/mp4' />
            </video>
            <el-row class='row1' :gutter='10' style='height: 100vh; justify-content: center;'>
                <el-col
                    class='col1Container'
                    :lg='14'
                    :md='20'
                ...
                >
                    ...
                    <h1 class='heading'>
                        Invest in the future at the G7 Summit.
                    </h1>
                    <el-row class='row2'>
                        <el-col
                            class='colPart2'
                ...
                >
                    <div class='container'>
                        <div class='container2'>
                            ...
                            >
                                <div class='pageTitle'>
                                    <h1>Unleash Your Potential - Register with a Click Below!</h1>
                                </div>
...
<script>
import summit from './components/g7Summit.vue'
