    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container3'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <p class='text1 text2'>
                        <span>F</span>ederal<br />
                        <span>O</span>pen<br />
                        <span>M</span>arket<br />
                        <span>C</span>ommittee
                    </p>
                    <p class='text1'>
                ...
                >
                    <div class='container2'>
                        ...
                        >
                            ...
                            <thirdLogin3 v-if='openAccountType === 0' />
                            <div
                ...
                <el-col
                    ...
                    :xs='22'
                >
                    <el-button class='trade lp_btn lp_btn_infoDetail' plain text @click='jumpPage(5)'>
                        <p class='lp_btn lp_btn_infoDetail'>
                            Watch FOMC Live Stream
                        </p>
                    </el-button>
                </el-col>
            </el-row>
        ...
        <div class='container1'>
            <div class='background2'>
                <el-row :gutter='10' style='justify-content: center; background-color: rgba(255,255,255,0.75)'>
                    <el-col
                        :lg='17'
                        :md='18'
                        :sm='19'
                    ...
                    >
                        <p class='content1'>
                            What is the Consumer Price Index & Federal Open Market Committee meeting?
                        </p>
                        <p class='content'>
                        ...
                        <p class='text'>
                            To receive Headline event notices, news, and analysis in your inbox, <el-link class='joinUs lp_btn lp_btn_infoDetail' href='https://www.headline.net/en-US/infoDetail?id=30713'>
                                Join us!
                            </el-link>
                        </p>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <h1 class='heading' style='text-shadow: rgba(0, 0, 0, 0.7) 6px 5px 6px;'>
                        CFDs instantly.
                    </h1>
                    <p class='text'>
                        Buy, Sell and Swap Your Money:
                    </p>
                    <p class='text'>
                        Simple and Fast
                    </p>
...
<script>
import information from './components/CwComponent8.vue'
...
.container3{
  background-image: url("../.././images/cpi1/fomc07/background2Cw.jpg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center center;
  .row1{
    background: rgba(255,255,255, 0.4);
    background-image: url("../.././images/cpi1/fomc07/background3Cw.jpg");
    background-repeat: no-repeat;
    background-position: center center;
    ...
    .regContainer{
      text-align: center;
      .trade{
            background: rgba(187, 36, 35, 0.98);
            color: #fff;
...
.container1 {
        .background2{
          background-image: url("../.././images/cpi1/fomc07/background1Cw.jpg");
          background-size: cover;
          background-repeat: no-repeat;
          background-position: center center;
        }
...
.register {
    ...
    .container {
        background-image: url("../.././images/cpi1/uscpi07/image2Cw.jpg");
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        .row1{
