        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <p class='subTitle'>
                        It's your time to make decision
                    </p>
                    <h1 class='title'>
                        NFP Trading Opportunity
                    </h1>
                    <p class='subTitle'>
                        Trade with HEADLINE only when trading signal there
                    </p>
                    <div class='buttonContainer'>
                        <el-button class='openLive lp_btn_infoDetail lp_btn' plain text @click='jumpPage(3)'>
                ...
                <el-col
                    ...
                    :xs='22'
                >
                    <img alt='nfp' class='nfp' src='../../images/cpi1/nfp08/imag1Mw.jpg' />
                </el-col>
            </el-row>
        </div>
        <router-view />
...
<script>
import information from '../promotion/nfp08-mw.vue'
...
import thirdLogin2 from '@/themeCommon/components/thirdLoginEvent11.vue'
