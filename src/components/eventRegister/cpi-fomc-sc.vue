<template>
    <div id='eventReg' ref='content' class='register'>
        <topNav />
        <div class='container'>
            <el-row class='row1' :gutter='10' style='justify-content: center; background: rgba(0, 0, 0, 0.2);'>
                <el-col
                    class='col1Container'
                    :lg='13'
                    :md='22'
                ...
                >
                    ...
                    <p class='content1'>
                        Experience the full potential of Headline.net, a comprehensive platform for CFD trading that provides a range of beneficial features. Seamlessly trade CFDs <span class='green bold'>
                            using cryptocurrencies
                        </span>, enjoy a simple and straightforward registration process without the need for Know Your Customer <span class='green'>
                            (KYC) requirements
                        </span> and tap into the opportunity for <span class='green bold'>
                            tax-free profits
                        </span>. Discover a wide variety of tradable assets and capitalize on profitable chances in the market. Take action now and sign up today to begin your CFD trading adventure with Headline.net.
                    </p>
                </el-col>
                <el-col
                    class='col2Container'
                ...
                >
                    <div class='container2'>
                        ...
                        >
                            ...
                            <div class='to-login'>
                                <p>Unlock Your Future - Register by Clicking Below!</p>
                            </div>
...
<script>
import partner from './components/cpiFomcScContent.vue'
