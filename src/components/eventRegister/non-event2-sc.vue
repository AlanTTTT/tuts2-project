<template>
    <div id='eventReg' ref='content' class='register'>
        <topNav />
        <div class='container1Background'>
            <el-row style='justify-content: space-evenly;'>
                <el-col
                    ...
                    :xs='0'
                >
                    <img alt='bull' class='animals' src='../../images/cpi1/non-event2/bull.jpg' />
                </el-col>
                <el-col
                    class='container1Col'
                    :lg='13'
                ...
                >
                    <h1 class='title'>
                        Unleash Your Inner Bull: Register Now
                    </h1>
                    <thirdLogin2 v-if='openAccountType === 0' />
                </el-col>
                <el-col
                    :lg='4'
                    :md='4'
                    ...
                    :xs='0'
                >
                    <img alt='bull' class='animals' src='../../images/cpi1/non-event2/bear.jpg' />
                </el-col>
            </el-row>
        </div>
        <nonEventCards />
        <div class='container'>
            ...
            <div class='titleContainer'>
                <h1 class='title1'>
                    Headline.net - The Trusted Choice of Serious Traders
                </h1>
            </div>
            <el-row class='row1' :gutter='50' style='justify-content: center;'>
                <el-col
                    class='col1Container'
                    :lg='11'
                    :md='22'
                ...
                >
                    ...
                    <p class='content2'>
                        Instant Trading, Easier than Ever Before. Buy, Sell, and Swap Crypto Effortlessly, with Lightning Speed.
                    </p>
                ...
                >
                    <div class='container2'>
                        ...
                        >
                            ...
                            <div class='to-login'>
                                <h1>Join the Revolution, Act Now and Seamlessly Swap Cryptocurrencies in an Instant!</h1>
                                <p>Sign up for a Headline.net account to get a secure crypto experience</p>
                            </div>
                            <thirdLogin2 v-if='openAccountType === 0' style='margin-bottom: 20px;' />
        ...
        <el-dialog
            ...
            custom-class='imageDialog'
            :show-close='false'
            :width='1000'
        >
            <div>
                <p class='title'>
                    START USING<br />DIGITAL MONEY
                </p>
                <p class='dialogContent1'>
                    <span>
                        TAX FREE x NO KYC x PRECISE TRADING TIPS
                    </span>
                </p>
                <thirdLogin3 style='max-width: 500px; position: relative' />
                <p class='dialogContent2'>
                    HURRY UP! JUST ONE CLICK AND RECEIVE THE IMPORTANT NOTICE
                </p>
            </div>
            <div>
...
<script>
import nonEventCards from './components/nonEvent2ScCards.vue'
import partner from './components/non-event2-content.vue'
...
import thirdLogin2 from '@/themeCommon/components/thirdLoginEvent3.vue'
import thirdLogin3 from '@/themeCommon/components/thirdLoginEvent12.vue'
...
export default {
    ...
    setup () {
        ...
        const closeNotice = (flag) => {
            ...
            if (flag) {
                const url = bulletinBox?.jumpType == 1 ? 'infoDetail' : 'economicCalendar'
...
.imageDialog {
    ...
    .el-dialog__body {
        ...
        & > div:first-of-type {
            background: url("https://www.headline.net/wp-content/uploads/2023/07/popUpBg.png");
...
.register {
    ...
    .container {
        background: linear-gradient(rgba(36,35,35,0.5), rgba(36,35,35,0.5)), url("../../images/cpi1/non-event2/backgroundSc.jpg");
        background-size: cover;
        background-repeat: no-repeat;
