<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1'>
            <el-row :gutter='10' style='justify-content: center'>
                ...
                >
                    ...
                    <p class='content'>
                        Gain a comprehensive understanding of the Federal Open Market Committee (FOMC) meeting, including its schedule and significance to traders.
                    </p>
        ...
        <el-row class='container21' :gutter='10' style='justify-content: center'>
            <div class='containerLayer'>
                ...
                >
                    <h1 class='title'>
                        What is Federal Open Market Committee meeting?
                    </h1>
                    <p class='content'>
                    ...
                    <p class='text text2'>
                        To receive Headline event notices, news, and analysis in your inbox, <el-link class='text underline red lp_btn_infoDetail lp_btn' href='https://www.headline.net/en-US/infoDetail?id=28207' target='_blank' :underline='false'>
                            Join us!
                        </el-link>
                    </p>
                </el-col>
...
<script>
import information from './components/CwComponent3.vue'
...
.register {
    ...
    .container21{
      position: relative;
      z-index: 999;
      background-image: url("../.././images/cpi1/cpi-fomc/background1CW.jpg");
      background-size: cover;
      background-repeat: no-repeat;
      background-position: center center;
      .containerLayer{
    ...
    .container {
        background-image: url("../.././images/cpi1/cpi-fomc/background2CW.jpg");
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        .row1{
