            ...
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <div class='buttonContainer'>
                        <el-button class='infoDetail lp_btn_register lp_btn' plain text @click='jumpPage(2)'>
                    ...
                    <div class='buttonContainer2'>
                        ...
                        <div class='buttonContainer3'>
                            <el-button class='infoDetail infoDetail2 lp_btn_infoDetail lp_btn' plain text @click='jumpPage(3)'>
                                <p class='lp_btn_infoDetail lp_btn'>
                                    Know More
                                </p>
                            </el-button>
...
<script>
import information from '../promotion/fomc07Content-mw.vue'
