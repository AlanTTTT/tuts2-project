<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='part1Container'>
            ...
            <p>Through Our Expert Analysis Of The Influential U.S. FOMC Meeting</p>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 50px 0; justify-content: center;'>
                ...
                >
                    <p class='text yellow'>
                        Economic Calendar<br />U.S. FOMC : July 25, 2023
                    </p>
                    <h1 class='heading'>
                    ...
                    <p class='content1'>
                        The market is starting to doubt whether the Federal Reserve will soon <span class='red underline'>
                            signal the end of its monetary tightening policy.
                        </span><br />
...
<script>
import partner from './components/fomc07EtContent.vue'
