    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container4'>
            <el-row class='row4' :gutter='10'>
                ...
                >
                    <h1 class='text1'>
                        Trade CFDs on Commodities,<br />Forex and Cryptocurrencies
                    </h1>
                    <p class='text2'>
                        Reliable, Simple, Innovative<br />Join millions who have already traded with Headline.net
                    </p>
                    <thirdLogin />
                </el-col>
            </el-row>
        ...
        <div class='container3'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <p class='text2'>
                        Start Trading through Headline.net direct in 3 mins
                    </p>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    Don't Miss Our<br />
                    <span>C</span>onsumer <span>P</span>rice <span>I</span>ndex<br />
                    Trading Opportunities Grab & Go
                    <div class='regContainer'>
                            ...
                            <div class='registerCard'>
                                <div class='pageTitle'>
                                    <div>
                                        ...
                                        <p class='subTitle'>
                                            Open a Demo or Live Account for <span>FREE</span>
                                        </p>
                                    </div>
...
<script>
import information from './components/CwComponent10.vue'
import information2 from './components/CwComponent11.vue'
...
.container3{
  ...
  .row1{
    ...
    .col2Container{
      background-image: url("../../images/cpi1/nfp08/background1Cw.jpg");
