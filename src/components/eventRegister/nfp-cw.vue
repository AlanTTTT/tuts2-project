<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container1'>
            <el-row :gutter='10' style='justify-content: center; background: rgba(255,255,255,0.3)'>
                <el-col
                    :lg='14'
                    :md='16'
                    :sm='18'
                    style='align-self: center; padding: 60px 0;'
                    :xl='12'
                    :xs='20'
                >
                    <h1 class='title'>
        ...
        <el-row class='container2' :gutter='10' style='justify-content: center; background-color: rgb(125,24,23)'>
            <el-col
                class='container2Col'
                :lg='14'
                :md='16'
            ...
            >
                ...
                <p class='content'>
                    The non-farms payroll report (NFP) is a monthly release of data on the80% of the US workforce employed in manufacturing, construction and goods.
                </p>

                <h1 class='title title2'>
                    Why Non-Farm Payrolls important?
                </h1>
                <p class='content'>
                    Investors and traders know the Federal Reserve of the United States monetary policies are closely linked with NFP data.
                </p>
                <p class='content'>
                ...
                <p class='text text2'>
                    To receive Headline event notices, news, and analysis in your inbox, <el-link class='text underline' href='https://www.headline.net/en-US/register' target='_blank' :underline='false'>
                        Join us!
                    </el-link>
                </p>
                <div class='buttonContainer'>
                    <el-button class='trade lp_btn lp_btn_register' plain text @click='jumpPage(1)'>
                        <p class='trade lp_btn lp_btn_register'>
                            Register
                        </p>
                    </el-button>
                </div>
...
<script>
import information from './components/CwComponent2.vue'
...
.container1 {
        background-image: url("../.././images/cpi1/nfp/cwBanner.jpg");
