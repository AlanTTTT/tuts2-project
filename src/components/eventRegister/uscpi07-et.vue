<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='part1Container'>
            ...
            <p>Through Our Expert Analysis Of The Influential U.S. CPI Data</p>
            <thirdLoginButton />
        </div>
        <div class='container'>
            <el-row class='row1' :gutter='40' style='padding: 50px 0; justify-content: center;'>
                ...
                >
                    <p class='text yellow'>
                        Economic Calendar<br />U.S. CPI : July 12, 2023
                    </p>
                    <h1 class='heading'>
                    ...
                    <p class='content1'>
                        <span class='underline bold'>
                            Headline.net
                        </span> is a CFD trading platform that offers a wide range of features and benefits, including <span class='red'>
                            the ability to use Crypto to trade CFDs, NO KYC requirements, tax-free profits
                        </span>, and a wide range of tradable assets.<br />
                        <span class='red'>
                            <span class='underline'>
                                Register now
                            </span> and start trading CFDs with Headline.net
                        </span>
                    </p>
...
<script>
import partner from './components/cpi07EtContent.vue'
