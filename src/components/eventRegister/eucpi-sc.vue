    ...
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    <h1 class='heading'>
                        Euro Forex Strategies: How to Generate <span class='yellow bold'>
                            20%+ Profits
                        </span> from EU CPI?
                    </h1>
                    <div class='container2'>
                        ...
                        >
                            ...
                            <h1 class='text brown' style='text-align: center'>
                    ...
                    <el-row class='row2' :gutter='10'>
                        ...
                        >
                            ...
                            <div class='buttonContainer'>
                                <el-button class='productButton productButton1 lp_btn lp_btn_trade' plain text @click='jumpPage(2)'>
                                    <p class='lp_btn lp_btn_trade'>
                                        EUR/USD
                                    </p>
                                </el-button>
                                <el-button class='productButton  productButton2 lp_btn lp_btn_trade' plain text @click='jumpPage(3)'>
                                    <p class='lp_btn lp_btn_trade'>
                                        EUR/GBP
                                    </p>
                                </el-button>
                                <el-button class='productButton productButton3 lp_btn lp_btn_trade' plain text @click='jumpPage(4)'>
                                    <p class='lp_btn lp_btn_trade'>
                                        EUR/JPY
                                    </p>
                                </el-button>
                    ...
                    <el-row class='arrowContainer' :gutter='10'>
                        <el-col
                            class='col3'
                            :lg='5'
                            :md='6'
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/g7-summit/people.png' />
                                <p class='text'>
                                    No KYC
                                </p>
                            </div>
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/g7-summit/bitcoin.svg' />
                                <p class='text'>
                                    Trade Crypto and Fiat CFD
                                </p>
                            </div>
                        </el-col>
                        <el-col
                        ...
                        >
                            <div class='point'>
                                <img alt='arrow' class='arrow' src='../../images/cpi1/g7-summit/money.png' />
                                <p class='text'>
...
<script>
import information from './components/eucpiScContent.vue'
...
import thirdLogin from '@/themeCommon/components/thirdLoginEvent3.vue'
        ...
        const jumpPage = (attr) => {
            switch (attr) {
                case 1 :
                    ...
                    break
                case 2 :
                    window.open('https://www.headline.net/en-US/order?name=EUR/USD&symbolId=1437&tradeType=1')
                    break
                case 3 :
                    window.open('https://www.headline.net/en-US/order?name=EUR/GBP&symbolId=1446&tradeType=1')
                    break
                case 4 :
                    window.open('https://www.headline.net/en-US/order?name=EUR/JPY&symbolId=1445&tradeType=1')
                    break
            }
        }
...
.register {
    ...
    .container {
        background-image: url("../../images/cpi1/eucpi/backgroundImgSc.jpg");
