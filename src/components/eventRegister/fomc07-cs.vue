<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='background1'>
            <h1>Trade with Headline.net, Master the Markets</h1>
            <p>Stay Informed, Stay Ahead. Register with Headline.net for Global Event Updates.</p>
            <thirdLogin2 />
        </div>
        <div class='container'>
            <el-row class='row1' :gutter='10'>
                ...
                >
                    ...
                    <h1 class='yellow heading'>
                        Great Trading Chance
                    </h1>
                    <p class='content1'>
                        Watch Live in <span class='lp_btn lp_btn_infoDetail' @click='jumpPage(1)'>
                            Headline.net Hot Event
                        </span>
                    </p>
                </el-col>
                <el-col
...
<script>
import partner from './components/fomcCsContent.vue'
import partner2 from './components/partner-red.vue'
...
.register {
  ...
  .container {
      background-image: linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)), url("../.././images/cpi1/uscpi07/imageCw.jpg");
