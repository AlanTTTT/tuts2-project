<template>
    <div id='eventReg' ref='content' class='register'>
        ...
        <div class='container'>
            <el-row class='row1' :gutter='50' style='justify-content: center; background: rgba(128, 128, 128, 0.3);'>
                <el-col
                    class='col1Container'
                    :lg='12'
                    :md='22'
                ...
                >
                    <p class='text yellow'>
                        ...
                        NFP report : 7 July, 2023
                    </p>
                    <h1 class='heading'>
                        To capitalize on the NFP report data and make a successful trade.
                    </h1>
                    <p class='content1'>
                        Experience the full potential of <span class='green'>
                            tax-free trading with cryptocurrencies
                        ...
                        </span> Capitalize on profitable opportunities in the market and embark on your trading adventure. Sign up today and tap into the benefits of trading tax-free with crypto on Headline.net.
                    </p>
                </el-col>
                <el-col
                    class='col2Container'
                ...
                >
                    <div class='container2'>
                        ...
                        >
                            ...
                            <div class='to-login'>
                                <h1>Get Started Today - Click Below to Secure Your Place!</h1>
...
<script>
import partner from './components/nfp07FomcScContent.vue'
...
.container1Background{
  background-image: url("../.././images/cpi1/nfp07/backgroundImg1Sc.jpg");
